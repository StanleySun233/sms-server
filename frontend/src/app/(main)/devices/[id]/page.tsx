...
export default function DeviceDetailPage() {
  ...
  const handleCheckUsername = async () => {
    ...
    const res = await deviceApi.checkTransferUsername(username).then((r) => r.data).catch((err: any) => {
      ...
      const msg = raw.includes('transfer to self') ? t('cannotTransferToSelf') : (raw || t('userNotFound'));
      ElMessage.error(msg);
      return null;
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <div className="text-white text-lg">{device.signalStrength != null ? `${device.signalStrength} dBm` : '-'}</div>
              </div>
            </div>
            <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="text-white text-lg">{formatDateTime(device.createdAt)}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <h2 className="text-2xl font-semibold text-white mb-6">{t('deviceManagement')}</h2>
          <div className="space-y-4">
            <div>
          ...
          <div className="flex gap-4 mt-8">
            <button
              onClick={() => router.push(`/devices/${device.id}/log`)}
