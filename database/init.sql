...
CREATE TABLE IF NOT EXISTS devices (
    ...
    last_heartbeat_at TIMESTAMP NULL DEFAULT NULL COMMENT 'Last webhook heartbeat time',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT 'Device creation time',
...
CREATE TABLE IF NOT EXISTS sms_message (
    ...
    read_at TIMESTAMP NULL DEFAULT NULL COMMENT 'Time when marked as read',
...
CREATE TABLE IF NOT EXISTS missed_call (
    ...
    call_time TIMESTAMP NOT NULL COMMENT 'Time of the missed call',
...
CREATE TABLE IF NOT EXISTS pending_sms (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT 'Time when message was queued',
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Last update time',
    sent_at TIMESTAMP NULL DEFAULT NULL COMMENT 'Time when message was sent',
    delivered_at TIMESTAMP NULL DEFAULT NULL COMMENT 'Time when message was delivered',
    FOREIGN KEY (device_id) REFERENCES devices(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS sim_change_log (
    ...
    changed_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT 'Time of SIM card change',
    FOREIGN KEY (device_id) REFERENCES devices(id) ON DELETE CASCADE,
